...
.egg-wrapper:nth-child(1) {
  transform: rotateZ(90deg) translateX(100px) rotateZ(-90deg) rotateX(-90deg);
}
.egg-wrapper:nth-child(2) {
  transform: rotateZ(210deg) translateX(100px) rotateZ(-210deg) rotateX(-90deg);
}
.egg-wrapper:nth-child(3) {
  transform: rotateZ(330deg) translateX(100px) rotateZ(-330deg) rotateX(-90deg);
}
